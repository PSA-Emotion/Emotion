        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">APIE MUS - </h2>
                    <p class="font-italic text-muted mb-4">Kai kurios emocijos būna tokios galingos, kad mus palaužia, nesvarbu, ar jos geros, ar blogos. Tam ir esame mes EMOCIJA, kad padėtume išspręsti vidinio skausmo, nepsitikėjimo savimi problemas. Emocijos ne visuomet nedelsiant priverčia susimąstyti, bet jos visuomet nedelsiant priverčia veikti, todėl mes norime padėti pasiekti geriausios emocijos viršūnę.</p>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">KAIP VISKAS PRASIDĖJO? - </h2>
                    <p class="font-italic text-muted mb-4">Covid - 19 pandemija prasidėjo.... Karantinas paskebtas. Prasidėjo darbas ir mokslas iš namų. Visa tai mus stipriai paveikė, kiekviena diena buvo vis sunkesnė emociškai, todėl mąstėme, kas mums ir kitiems padėtų pasijusti geriau, nes žinojome, kad tai ne tik mūsų bet ir kitų problema. Todėl mum gimė idėja, EMOCIJA.</p>
                </div>
            </div>
        </div>
    </div>
